    ...
    internal class GenericComponentPass : IntermediateNodePassBase, IRazorOptimizationPass
    {
        ...
        private class Visitor : IntermediateNodeWalker, IExtensionIntermediateNodeVisitor<ComponentExtensionNode>
        {
            ...
            private void Process(ComponentExtensionNode node)
            {
                ...
                var rewriter = new TypeNameRewriter(bindings);
            ...
            private string RewriteTypeName(TypeNameRewriter rewriter, string typeName)
            {
        ...
        private class TypeNameRewriter : CSharpSyntaxRewriter
        {
            ...
            public TypeNameRewriter(Dictionary<string, Binding> bindings)
            {
                _bindings = bindings;
            }
